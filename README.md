...
| 平台 | 下载 |
|------|------|
| 🍎 macOS (Apple Silicon / Intel) | [**智能OCR工具_macOS_v1.0.1.dmg**](https://github.com/anon-research-tools/intelligent-ocr/releases/latest/download/智能OCR工具_macOS_v1.0.1.dmg) |
| 🪟 Windows 10/11 (64位) | [**智能OCR工具_安装程序_v1.0.1.exe**](https://github.com/anon-research-tools/intelligent-ocr/releases/latest/download/智能OCR工具_安装程序_v1.0.1.exe) |
